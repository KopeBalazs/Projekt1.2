...
public class FireBaseAdapter {
    ...
    public void addLongValueToDatabase(long value, String path) {
        //Log.d(TAG, "Arrived in addStringValueToDatabase");
        ...
        executeDatabaseSetValueByValueAndPathArrayLong(value, pathArray);
    }
    public void addBooleanValueToDatabase(Boolean value, String path) {
        //Log.d(TAG, "Arrived in addStringValueToDatabase");
        ...
        executeDatabaseSetValueByValueAndPathArrayBoolean(value, pathArray);
    }
    ...
    private void executeDatabaseSetValueByValueAndPathArrayBoolean(Boolean value, ArrayList<String> pathArray) {
    ...
    private void executeDatabaseSetValueByValueAndPathArrayLong(long value, ArrayList<String> pathArray) {
